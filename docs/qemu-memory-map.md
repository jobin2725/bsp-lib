# Qemu Virt Memory Map Explained
This document shows the memory map of a qemu-virt simulator.

## Memory Map Summary
|Device             |Address        |Size       |Description            |
|:-----------------:|:-------------:|:---------:|:---------------------:|
|test device        |0x00100000     |-          |Qemu poweroff/reboot   |
|rtc (goldfish)     |0x00101000     |4KB        |Real-time Clock        |
|fw-cfg             |0x10100000     |24B        |Qemu Firmware Config   |
|uart0 (ns16550a)   |0x10000000     |256B       |Serial Console         |
|clint              |0x02000000     |64KB       |Timer, S/W Interrrupt  |
|plic               |0x0C000000     |2MB+       |Ext. Interrupt Ctrlr   |
|flash              |0x20000000     |64MB       |Flash Memory           |
|Memory (RAM)       |0x80000000     |128MB      |Main Memory            |
